...
function EventItem ({event}) {
    ...
    return (
        <div className="event__row">   
            ...
            <div><p>{new Date(event.startDate).toLocaleString('en-US', options)} at {event.startTime}</p></div>
            <div><p>{new Date(event.endDate).toLocaleString('en-US', options)} at {event.endTime}</p></div>
